<template>
  <div class="logo-imagina" style="display: inline-flex" id="logo-imagina-svg">
    <a href="https://imaginacolombia.com/" target="_blank" style="display: inline-flex">
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
           xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
           width="80px" height="35px" viewBox="0 25.289 288 81.333"
           enable-background="new 0 25.289 288 81.333" xml:space="preserve"
      >
          <g>
            <path :style="`fill : ${color}`" class="imaginalogo" d="M150.728,57.953l28.326,25.377h4.668V55.011h-3.445v24.784l-26.779-24.784h-6.176v28.32h3.406V57.953
            ...
            <path :style="`fill : ${color}`" class="imaginalogo" d="M226.062,94.029c-0.166-0.134-0.412-0.28-0.652-0.379c-0.256-0.091-0.613-0.175-1-0.216l-1.002-0.165
            ...
            <path :style="`fill : ${color}`" class="imaginalogo" d="M6.844,47.032H5.103V31.664h7.089c0.838,0,1.556,0.057,2.154,0.193c0.604,0.124,1.096,0.352,1.485,0.688
