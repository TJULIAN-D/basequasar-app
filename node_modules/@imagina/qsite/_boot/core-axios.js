...
export default function ({app, router, store, Vue, ssrContext}) {
  ...
  axios.interceptors.request.use(function (config) {
    ...
    //Give instant feedback that something is happening, regardless of how slow the backend responds
    LoadingBar.start()
    //Return config
    return config;
  }, function (error) {
  ...
  axios.interceptors.response.use((response) => {
    ...
    //Stop the loading bar (even for canceled requests, to keep the start/stop count balanced)
    LoadingBar.stop()
